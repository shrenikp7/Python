...
#### create file for each database, execute SQL statement, put output of sql statement in file
#### and close the file. Scritp is running for loop inside the for loop.
####
import MySQLdb
import os
import time
